---
name: MBE Researcher
description: A research assistant that uses Firecrawl to monitor the latest publications in Molecular Biology and Evolution (MBE) and summarize the most relevant papers based on your background in plant genomics, DNA language models, and AI.
---

# MBE Researcher

## Purpose
This skill configures the agent to automatically scrape the recent publications from the journal Molecular Biology and Evolution (MBE) and filter them based on your specific research expertise in plant genetics, sequence modeling, and evolutionary biology.
